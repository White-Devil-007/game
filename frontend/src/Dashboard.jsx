            ...
            <div className="border border-cyan-500/20 bg-black/40 p-3 rounded flex flex-col gap-2 items-center justify-between">
              ...
              <div class="relative w-14 h-14 flex items-center justify-center">
                <svg class="w-full h-full transform -rotate-90" viewBox="0 0 56 56">
                  <circle cx="28" cy="28" r="23" class="stroke-[#0B0F17] fill-transparent" stroke-width="3.5"></circle>
                  <circle cx="28" cy="28" r="23" class="stroke-[#00D2FF] fill-transparent drop-shadow-[0_0_4px_#00D2FF]" stroke-width="3.5" stroke-dasharray="144" stroke-dashoffset="50.4"></circle>
                </svg>
                <div class="absolute text-[10px] font-black text-white">65%</div>
              </div>
                ...
                {timeline.map((era, idx) => (
                  <div key={idx} className="relative group">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="text-[10px] text-gray-300 leading-relaxed font-sans font-mono">
                        {era.summary}
                      </p>
                    </div>
                  </div>
              ...
              <div className="flex flex-col gap-4 text-[10px]">
                ...
                <div className="grid grid-cols-2 gap-4 border-b border-cyan-500/5 pb-2.5">
                  <div className="border-r border-cyan-500/10 pr-2">
                    ...
                    <p className="text-gray-400 leading-relaxed font-sans font-mono">{report.governance.earth}</p>
                  </div>
                  <div>
                    <span className="text-[#00D2FF] font-bold uppercase block mb-1">🤖 SIMULATED GOVERNANCE</span>
                    <p className="text-gray-300 leading-relaxed font-sans font-mono">{report.governance.simulation}</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 border-b border-cyan-500/5 pb-2.5">
                  <div className="border-r border-cyan-500/10 pr-2">
                    ...
                    <p className="text-gray-400 leading-relaxed font-sans font-mono">{report.architecture.earth}</p>
                  </div>
                  <div>
                    <span className="text-[#00D2FF] font-bold uppercase block mb-1">🏢 SIMULATED ARCHITECTURE</span>
                    <p className="text-gray-300 leading-relaxed font-sans font-mono">{report.architecture.simulation}</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="border-r border-cyan-500/10 pr-2">
                    ...
                    <p className="text-gray-400 leading-relaxed font-sans font-mono">{report.language.earth}</p>
                  </div>
                  <div>
                    <span className="text-[#00D2FF] font-bold uppercase block mb-1">📡 SIMULATED LANGUAGE</span>
                    <p className="text-gray-300 leading-relaxed font-sans font-mono">{report.language.simulation}</p>
                  </div>
                </div>
              </div>
            )}
